# -*- coding: utf-8 -*-
"""
evaluate active global CS-MIA under defense with --defense parameter, support following:
...
def mia_compare(server_models, target_client_models, train_loader, test_loader, args):
    ...
    if dropout:
        logging.debug('active global CS-MIA dropout_p {}: acc {}, pre {}, recall {}, f1 {}'.format(args.dropout_p, acc, pre, recall, f1))
    else:
